...
<template>
  <div class="hostmachine">
                  ...
                  <el-popover placement="right" trigger="hover">
                    <div class="treekub">
                      ...
                      <!-- <div
                        ...
                        @click="gotu('/techniqueandtactics')"
                      >
                        技战术知识库
                      </div> -->
                    </div>
    ...
    <div class="tandialog">
      ...
      >
        <div style="color: #fff; text-align: center; font-size: 18rem">
          编辑
        </div>
        <div style="color: #fff">xxxxxxxxxxxxx</div>
        <div style="color: #fff">xxxxxxxxxxxxx</div>
        <div style="color: #fff">xxxxxxxxxxxxx</div>
        <div style="color: #fff">xxxxxxxxxxxxx</div>
        <div style="color: #fff">xxxxxxxxxxxxx</div>
...
export default {
  ...
  methods: {
    ...
    gotu(e) {
      // console.log(e)
      this.$router.push("/hostmachinedetails");
    },
  },
};
</script>
