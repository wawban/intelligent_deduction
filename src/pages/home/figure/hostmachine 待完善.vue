    ...
    <div class="xxx wbb">
      ...
      <div v-for="(e, i) in data" :key="i">
        ...
        <div class="terewenr" style="background: #292929;">
          <i @click="style('test'+i,$event)" v-if="e.children && e.children.length != 0" class="el-icon-arrow-right"></i>
            <div :class="treekry==e.label?'xuanz weizc':'weizc'" @click="onxuanz(e)">{{ e.label }}</div>
            <div class="sandina">
              <el-popover placement="right" trigger="hover">
                ...
                <div slot="reference">
                  <img style="height: 16rem" src="../img/sd.png" alt="" />
                </div>
              </el-popover>
            </div>
        </div>
        <!-- 循环二层 -->
        <!-- <div style="display: none;" :class="'test'+i" v-for="(e1, i1) in e.children" :key="i1"> -->
        <div style="display: none;" :class="'test'+i" v-for="(e1, i1) in e.children" :key="i1">
          <!-- 二层内容 -->
          <div class="terewenr" style="background: #161616;">
            <i @click="style('testt'+i1,$event)" v-if="e1.children && e1.children.length != 0" class="el-icon-arrow-right"></i>
            <div v-else style="width: 60rem;"></div>
            <!-- <div :class="treekry==e1.label?'xuanz weizc':'weizc'" @click="onxuanz(e1)" style="padding-left: 20rem;">{{ e1.label }}</div> -->
            <div :class="treekry==e1.label?'xuanz weizc':'weizc'" @click="onxuanz(e1)" style="padding-left: 20rem;">{{ e1.label }}</div>
            <div class="sandina">
              <el-popover placement="right" trigger="hover">
                <div class="treekub">
          ...
          <!-- 循环三层 -->
          <div style="display: none;" :class="'testt'+i1" v-for="(e2, i2) in e1.children" :key="i2">
            <!-- 三层内容 -->
            <div class="terewenr" style="background: #000000;">
              <i @click="style('test2'+i,$event)" v-if="e2.children && e2.children.length != 0" class="el-icon-arrow-right"></i>
              <div v-else style="width: 60rem;"></div>
              <div :class="treekry==e2.label?'xuanz weizc':'weizc'" @click="onxuanz(e2)" style="padding-left: 40rem;">{{ e2.label }}</div>
              <div class="sandina">
                <el-popover placement="right" trigger="hover">
                  <div class="treekub">
...
export default {
  ...
  methods: {
    ...
    style(e,event){
      alert(5)
      // alert(e)
      // console.log(event.target.className   el-icon-arrow-right)
